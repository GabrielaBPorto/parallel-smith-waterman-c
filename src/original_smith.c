...
int main(int argc, char* argv[]) {
    ...
    //Allocates a and b
    a = malloc(m * sizeof(char)); // Para a Linha
    b = malloc(n * sizeof(char)); // Para a Coluna. No entanto vetores que inicializam com valores vazios
 ...
 */
//Entra como parametros, o indice na matriz de similaridade, a matriz de similaridade e a matriz de predecessor
void similarityScore(long long int i, long long int j, int* H, int* P, long long int* maxPos) {
